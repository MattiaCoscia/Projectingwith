...
GRANT ALL PRIVILEGES ON DATABASE pawtropolis TO docker;

CREATE TABLE IF NOT EXIST game_map(
...
CREATE TABLE IF NOT EXIST type_room(
id INT PRIMARY KEY NOT NULL,
name VARCHAR(24) UNIQUE NOT NULL);
...
CREATE TABLE IF NOT EXIST room_connection(
id INT PRIMARY KEY NOT NULL,
...
CREATE TABLE IF NOT EXIST item_room(
Id INT PRIMARY KEY NOT NULL,
...
CREATE TABLE IF NOT EXIST item_bag(
Id INT PRIMARY KEY NOT NULL,
quantity INT NOT NULL,
item_id INT NOT NULL references item(id),
